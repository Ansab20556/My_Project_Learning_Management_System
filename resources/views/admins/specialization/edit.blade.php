            ...
            <form action="{{ route('admin.specializations.update', $specialization->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="what_you_will_learn" id="what_you_will_learn" rows="4"
                              class="form-control @error('what_you_will_learn') is-invalid @enderror">{{ old('what_you_will_learn', $specialization->what_you_will_learn) }}</textarea>
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-success">تحديث التخصص</button>
